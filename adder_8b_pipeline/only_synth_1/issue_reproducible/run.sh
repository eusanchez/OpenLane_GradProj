...
export QUIT_ON_SYNTH_CHECKS='1';
export RIPPLE_CARRY_ADDER_MAP='pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/rca_map.v';
export SAVE_NETLIST='./results/synthesis/adder_8b_pipeline.v';
...
export VERILOG_FILES='openlane/designs/adder_8b_pipeline/src/adder_8b_pipeline.v openlane/designs/adder_8b_pipeline/src/adder_4b.v';
