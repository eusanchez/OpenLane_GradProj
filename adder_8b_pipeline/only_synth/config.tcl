...
set ::env(GLB_CFG_FILE) {/openlane/designs/adder_8b_pipeline/runs/only_synth/config.tcl}
...
set ::env(LOGS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs}
...
set ::env(REPORTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports}
set ::env(RESULTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth}
set ::env(RUN_DRT) {1}
...
set ::env(START_TIME) {2023.04.04_22.05.09}
...
set ::env(TMP_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp}
...
set ::env(cts_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/cts}
set ::env(cts_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/cts}
set ::env(cts_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/cts}
set ::env(cts_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/cts}
set ::env(floorplan_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/floorplan}
set ::env(floorplan_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/floorplan}
set ::env(floorplan_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/floorplan}
set ::env(floorplan_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/floorplan}
set ::env(placement_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/placement}
set ::env(placement_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/placement}
set ::env(placement_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/placement}
set ::env(placement_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/placement}
set ::env(routing_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/routing}
set ::env(routing_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/routing}
set ::env(routing_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/routing}
set ::env(routing_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/routing}
set ::env(signoff_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/signoff}
set ::env(signoff_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/signoff}
set ::env(signoff_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/signoff}
set ::env(synthesis_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_INDEX) 4
set ::env(CURRENT_DEF) {0}
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_NETLIST) /openlane/designs/adder_8b_pipeline/runs/only_synth/results/synthesis/adder_8b_pipeline.v
