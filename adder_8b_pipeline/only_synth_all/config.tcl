...
set ::env(GLB_CFG_FILE) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/config.tcl}
...
set ::env(LOGS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs}
...
set ::env(REPORTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports}
set ::env(RESULTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all}
set ::env(RUN_DRT) {1}
...
set ::env(TMP_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp}
...
set ::env(cts_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/cts}
set ::env(cts_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/cts}
set ::env(cts_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/cts}
set ::env(cts_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/cts}
set ::env(floorplan_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/floorplan}
set ::env(floorplan_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/floorplan}
set ::env(floorplan_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/floorplan}
set ::env(floorplan_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/floorplan}
set ::env(placement_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/placement}
set ::env(placement_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/placement}
set ::env(placement_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/placement}
set ::env(placement_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/placement}
set ::env(routing_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/routing}
set ::env(routing_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/routing}
set ::env(routing_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/routing}
set ::env(routing_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/routing}
set ::env(signoff_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/signoff}
set ::env(signoff_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/signoff}
set ::env(signoff_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/signoff}
set ::env(synthesis_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_INDEX) 2
set ::env(CURRENT_DEF) {0}
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_NETLIST) /openlane/designs/adder_8b_pipeline/runs/only_synth_all/results/synthesis/adder_8b_pipeline.v
