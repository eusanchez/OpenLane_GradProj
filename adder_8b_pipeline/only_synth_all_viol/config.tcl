...
set ::env(DESIGN_CONFIG) {/openlane/designs/adder_8b_pipeline/config.json}
...
set ::env(GLB_CFG_FILE) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/config.tcl}
...
set ::env(LOGS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs}
...
set ::env(REPORTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports}
set ::env(RESULTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol}
set ::env(RUN_DRT) {1}
...
set ::env(TMP_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp}
...
set ::env(cts_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/cts}
set ::env(cts_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/cts}
set ::env(cts_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/cts}
set ::env(cts_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/cts}
set ::env(floorplan_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/floorplan}
set ::env(floorplan_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/floorplan}
set ::env(floorplan_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/floorplan}
set ::env(floorplan_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/floorplan}
set ::env(placement_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/placement}
set ::env(placement_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/placement}
set ::env(placement_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/placement}
set ::env(placement_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/placement}
set ::env(routing_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/routing}
set ::env(routing_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/routing}
set ::env(routing_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/routing}
set ::env(routing_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/routing}
set ::env(signoff_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/signoff}
set ::env(signoff_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/signoff}
set ::env(signoff_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/signoff}
set ::env(synthesis_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_INDEX) 2
set ::env(CURRENT_DEF) {0}
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_NETLIST) /openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/synthesis/adder_8b_pipeline.v
...
set ::env(DEF_UNITS_PER_MICRON) {1000}
set ::env(DESIGN_CONFIG) {/openlane/designs/adder_8b_pipeline/config.json}
set ::env(DESIGN_DIR) {/openlane/designs/adder_8b_pipeline}
set ::env(DESIGN_IS_CORE) {1}
set ::env(DESIGN_NAME) {adder_8b_pipeline}
set ::env(DETAILED_ROUTER) {tritonroute}
set ::env(DIODE_CELL) {sky130_fd_sc_hd__diode_2}
...
set ::env(LEC_ENABLE) {0}
set ::env(LEFT_MARGIN_MULT) {12}
set ::env(LIB_CTS) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/cts/cts.lib}
set ::env(LIB_FASTEST) {/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_SLOWEST) {/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis/trimmed.lib}
set ::env(LIB_SYNTH_COMPLETE) {/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis/merged.lib}
set ::env(LIB_SYNTH_NO_PG) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis/1-trimmed.no_pg.lib}
set ::env(LIB_TYPICAL) {/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_INSERT_POWER_PINS) {1}
...
set ::env(MERGED_LEF) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/merged.nom.lef}
set ::env(MERGED_LEF_MAX) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/merged.max.lef}
set ::env(MERGED_LEF_MIN) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/merged.min.lef}
set ::env(NETGEN_SETUP_FILE) {/root/.volare/sky130A/libs.tech/netgen/sky130A_setup.tcl}
set ::env(NO_SYNTH_CELL_LIST) {/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/no_synth.cells}
set ::env(OL_GIT_VERSION) {ed19423}
...
set ::env(ROUTING_CORES) {2}
set ::env(RSZ_DONT_TOUCH_RX) {\$^}
set ::env(RSZ_LIB) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(RSZ_USE_OLD_REMOVER) {0}
set ::env(RT_MAX_LAYER) {met5}
set ::env(RT_MIN_LAYER) {met1}
set ::env(RUN_CVC) {1}
...
set ::env(RUN_TAG) {only_synth_all_viol}
set ::env(RUN_TAP_DECAP_INSERTION) {1}
set ::env(SAVE_LIB) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/synthesis/adder_8b_pipeline.lib}
set ::env(SAVE_SDF) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/synthesis/adder_8b_pipeline.sdf}
set ::env(SCLPATH) {/root/.volare/sky130A/sky130_fd_sc_hd}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(signoff_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/signoff}
set ::env(synth_report_prefix) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_all_viol/tmp/synthesis}
set ::env(timer_start) {1680649362}
