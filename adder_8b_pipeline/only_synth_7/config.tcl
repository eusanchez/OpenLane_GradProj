...
set ::env(GLB_CFG_FILE) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/config.tcl}
...
set ::env(LOGS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs}
...
set ::env(REPORTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports}
set ::env(RESULTS_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7}
set ::env(RUN_DRT) {1}
...
set ::env(TMP_DIR) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp}
...
set ::env(cts_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/cts}
set ::env(cts_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/cts}
set ::env(cts_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/cts}
set ::env(cts_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/cts}
set ::env(floorplan_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/floorplan}
set ::env(floorplan_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/floorplan}
set ::env(floorplan_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/floorplan}
set ::env(floorplan_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/floorplan}
set ::env(placement_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/placement}
set ::env(placement_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/placement}
set ::env(placement_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/placement}
set ::env(placement_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/placement}
set ::env(routing_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/routing}
set ::env(routing_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/routing}
set ::env(routing_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/routing}
set ::env(routing_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/routing}
set ::env(signoff_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/signoff}
set ::env(signoff_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/signoff}
set ::env(signoff_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/signoff}
set ::env(signoff_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/signoff}
set ::env(synthesis_logs) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/logs/synthesis}
set ::env(synthesis_reports) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/reports/synthesis}
set ::env(synthesis_results) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/synthesis}
set ::env(synthesis_tmpfiles) {/openlane/designs/adder_8b_pipeline/runs/only_synth_7/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_INDEX) 2
set ::env(CURRENT_DEF) {0}
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_NETLIST) /openlane/designs/adder_8b_pipeline/runs/only_synth_7/results/synthesis/adder_8b_pipeline.v
